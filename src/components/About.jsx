...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="h-screen border-b-[12px] border-gray-200 bg-white flex flex-col md:flex-row"
    >
      {/* Left Side: Info */}
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start px-6 md:px-16 text-center md:text-left">
        ...
        <p className="max-w-md text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
          I'm <span className="font-semibold">Chetan</span>, a passionate Frontend Developer who builds fast,
          accessible, and beautiful websites. I focus on clean design and
          performance, inspired by minimal and immersive interfaces like
          Apple’s. Currently exploring React, Tailwind, and modern web
          technologies to deliver stunning digital experiences.
        </p>

        {/* Infinite Logo Carousel with masking on both sides */}
        <div className="mt-10 w-full overflow-hidden relative">
          <div className="flex flex-nowrap relative before:absolute before:left-0 before:w-32 before:h-full before:z-10 before:bg-gradient-to-r before:from-white before:to-transparent after:absolute after:right-0 after:w-32 after:h-full after:z-10 after:bg-gradient-to-l after:from-white after:to-transparent">
            <ul
              ref={logosRef}
            ...
            >
              ...
              <li><img src={chatgptLogo} alt="ChatGPT" /></li>
              <li><img src={javaLogo} alt="Java" /></li>
              <li><img src={springLogo} alt="Spring" /></li>
              <li><img src={hibernateLogo} alt="Hibernate" /></li>
              <li><img src={mysqlLogo} alt="MySQL" /></li>
              <li><img src={mongodbLogo} alt="MongoDB" /></li>
              <li><img src={vscodeLogo} alt="VSCode" /></li>
              <li><img src={intellijLogo} alt="IntelliJ" /></li>
            </ul>
          </div>
        </div>
      </div>
